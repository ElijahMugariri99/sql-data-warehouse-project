CREATE OR ALTER PROCEDURE bronze.load_bronze AS
 ...
 BEGIN
      ...
      BEGIN TRY
            ...
            PRINT '>>>> Inserting the Data Into :bronze.erp_px_g1v2';
      ...
      PRINT '>> Loading  Bronze_layer: is completed : ' + CAST(DATEDIFF(second, @batch_start_time, @batch_end_time) AS NVARCHAR) + 'seconds'
      PRINT '-----------------------';
